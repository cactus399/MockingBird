...
class MockingBird:
    def __init__(self, _ip="127.0.0.1", _port="5432", _uid="postgres", _pw="postgres", _db="mimic", _sch="mimiciii", _columnselection = ["*"], _tablesearchspace=["chartevents", "labevents", "cptevents", "datetimeevents", "diagnoses_icd", "procedures_icd", "procedureevents_mv"]):
        ##################################### WRAPPED PLATFORM#################
    ...
    def GetChart(self, _filter="", _mimicEntry=None, _mimicObject=None, _keyvaluepair=()):
    ...
    def ScanAdmissions(self, _tostring_func=None, _rootdir="C:\\MMd\\"):
